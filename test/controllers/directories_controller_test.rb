...
class DirectoriesControllerTest < ActionController::TestCase
  ...
  test "should create directory" do
    assert_difference('Directory.count') do
      post :create, directory: { description: @directory.description, image: @directory.image, name: @directory.name }
    end
  ...
  test "should update directory" do
    patch :update, id: @directory, directory: { description: @directory.description, image: @directory.image, name: @directory.name }
    assert_redirected_to directory_path(assigns(:directory))
  end
